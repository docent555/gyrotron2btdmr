function d = DAR(cu, cu_p, WL, WR, DPART, SQRTKAPPA, KAPPAJm1, KAPPAJ, Nz, C1, C2, coeff_4_d_3_m_SQRDT, coeff_1i_m_SQRDZ) %#codegen

Nzm1 = Nz - 1;

d1  = DD( 1, WL, DPART(1), SQRTKAPPA,  C1, coeff_4_d_3_m_SQRDT);

d2_Nzm1 = -coeff_1i_m_SQRDZ * (KAPPAJ*cu_p  + KAPPAJm1*cu) + DPART(2:Nzm1);
